...
import EmbeddedReportFormatRegisterModal from 'Assets/Modal/EmbeddedReportFormatRegisterModal';
 ...
 */
export default class EmbeddedReportFormatModal extends Component {
    ...
    loadFormatResult() {
        ...
        apiUrl && apiUrl.getFormatResult &&
            this.setState({ isLoading: true }, () => {
                sendData(EnumHttpMethod.get, apiUrl.getFormatResult, null, (formatResult, networkError) => {
    ...
    deleteFormats(formats) {
        const { apiUrl } = this.props;
        apiUrl && apiUrl.deleteFormats &&
            this.setState({ isProcessing: true }, () => {
                sendData(EnumHttpMethod.post, apiUrl.deleteFormats, formats, (result, networkError) => {
     ...
     */
    render() {
        const { show, authentication, enterprises, mainEnterprise, apiUrl } = this.props;
        ...
        return (
            <Modal bsSize="large" show={show} backdrop="static" onHide={() => this.onHide()}>
                ...
                <Modal.Body>
                    ...
                    <EmbeddedReportFormatRegisterModal
                        apiUrl={apiUrl}
...
EmbeddedReportFormatModal.propTypes = {
    show: PropTypes.bool,
