 ...
 * 回線メンテナンス画面のコンポーネント
 */
class LineMaintenancePanel extends Component {
    ...
    componentDidMount() {
        ...
        this.props.requestInitialInfo('line');
    }
     ...
     */
    loadAuthentication() {
        getAuthentication(FUNCTION_ID_MAP.lineMaintenance, (auth) => {
 ...
 */
export default connect(mapStateToProps, mapDispatchToProps)(LineMaintenancePanel);
