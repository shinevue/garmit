...
/**
 * RackMaintenance画面のコンポーネント
 */
class RackMaintenancePanel extends Component {
    ...
    componentDidMount() {
        ...
        this.props.requestInitialInfo('rack');
    }
     ...
     */
    loadAuthentication() {
        getAuthentication(FUNCTION_ID_MAP.rackMaintenance, (auth) => {
 ...
 */
export default connect(mapStateToProps, mapDispatchToProps)(RackMaintenancePanel);
