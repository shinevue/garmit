...
/**
 * コンシューマーメンテナンス画面のコンポーネント
 */
class ConsumerMaintenancePanel extends Component {
    ...
    componentDidMount() {
        ...
        this.props.requestInitialInfo('consumer');
    }
     ...
     */
    loadAuthentication() {
        getAuthentication(FUNCTION_ID_MAP.consumerMaintenance, (auth) => {
    ...
    */
    handleClickSave() {
        this.props.requestSave('consumer');
    }
 ...
 */
export default connect(mapStateToProps, mapDispatchToProps)(ConsumerMaintenancePanel);
