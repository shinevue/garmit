 ...
 * 配線盤メンテナンス画面のコンポーネント
 */
class PatchboardMaintenancePanel extends Component {
    ...
    componentDidMount() {
        ...
        this.props.requestInitialInfo('patchboard');
    }
     ...
     */
    loadAuthentication() {
        getAuthentication(FUNCTION_ID_MAP.patchboardMaintenance, (auth) => {
    ...
    */
    handleClickSave() {
        this.props.requestSave('patchboard');
    }
 ...
 */
export default connect(mapStateToProps, mapDispatchToProps)(PatchboardMaintenancePanel);
