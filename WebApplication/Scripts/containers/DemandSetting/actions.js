...
export const SET_EDITED_DEMANDSETS = 'SET_EDITED_DEMANDSETS';
...
/**
 * 編集中のデマンド設定をセットする
 * @param {any} demandSets
 */
export function setEditedDemandSets(demandSets) {
    return { type: SET_EDITED_DEMANDSETS, value: demandSets };
}