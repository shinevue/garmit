...
namespace garmit.Web.Controllers
{
    ...
    [AppSettings]
    [RoutePrefix("Maintenance/Power")]
    public class PowerSystemController : Controller
    {
        [Route("")]
        public ActionResult Index()
        {
            ControllerViewModel viewModel = new ControllerViewModel(Function.FUNCTION_ID_e.EGroupEdit);
