...
namespace garmit.Web.Controllers
{
    ...
    [AppSettings]
    [RoutePrefix("Maintenance/Consumer")]
    public class ConsumerMaintenanceController : Controller
    {
        [Route("")]
        public ActionResult Index()
        {
            ControllerViewModel viewModel = new ControllerViewModel(Function.FUNCTION_ID_e.ConsumerMaintenance);
